...
class RESTClient {
    ...
    fileprivate let kRestSignIn = "/user/session" // cryout@gmail.com // mysql/_table
    ...
    fileprivate func setUserDataFromJson(_ signInJson:JSON?) -> Bool {
        if let signInJson = signInJson {
            ...
            print("RestClient -> Session token : ", sessionToken ?? "No-token-8877", " Session Email : ", sessionEmail ?? "No-Email-8877")
        }
        else {
            sessionToken = nil
            sessionEmail = nil
