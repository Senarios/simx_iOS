...
class StarRatingView: UIView {
    ...
    fileprivate let fullStarImage: UIImage = UIImage(named: "FullStar")!
    fileprivate let halfStarImage: UIImage = UIImage(named: "HalfStar")!
    fileprivate let emptyStarImage: UIImage = UIImage(named: "EmptyStar")!
